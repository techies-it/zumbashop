...
namespace Bootsgrid\CashOnDeliveryFee\Model\Order;

use Bootsgrid\CashOnDeliveryFee\Model\Total\CashOnDeliveryFee;
...
class CashOnDeliveryFeeExtensionManagement
{
    ...
    public function setExtensionFromAddressData(Order $order, QuoteAddress $address)
    {
        $orderExtension = $this->getOrInitOrderExtension($order);
    ...
    private function getOrInitOrderExtension(Order $order)
    {
