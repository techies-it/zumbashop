...
namespace Bootsgrid\CashOnDeliveryFee\Model\Total\Invoice;
...
class CashOnDeliveryFee extends \Magento\Sales\Model\Order\Invoice\Total\AbstractTotal
{
    ...
    public function collect(\Magento\Sales\Model\Order\Invoice $invoice)
    {
        ...
        $invoice->setData(\Bootsgrid\CashOnDeliveryFee\Model\Total\CashOnDeliveryFee::TOTAL_CODE, $codFee);
        $invoice->setData(\Bootsgrid\CashOnDeliveryFee\Model\Total\CashOnDeliveryFee::BASE_TOTAL_CODE, $baseCodFee);
