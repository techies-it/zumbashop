...
namespace Bootsgrid\CashOnDeliveryFee\Model\Total\Creditmemo;
...
class CashOnDeliveryFee extends \Magento\Sales\Model\Order\Creditmemo\Total\AbstractTotal
{
    ...
    public function collect(\Magento\Sales\Model\Order\Creditmemo $creditmemo)
    {
        ...
        $creditmemo->setData(\Bootsgrid\CashOnDeliveryFee\Model\Total\CashOnDeliveryFee::TOTAL_CODE, $codFee);
        $creditmemo->setData(\Bootsgrid\CashOnDeliveryFee\Model\Total\CashOnDeliveryFee::BASE_TOTAL_CODE, $baseCodFee);
