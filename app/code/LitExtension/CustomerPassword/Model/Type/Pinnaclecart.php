...
class Pinnaclecart extends \LitExtension\CustomerPassword\Model\Type {
    ...
    public function validatePassword($customer, $username, $password, $pw_hash){
        ...
        if($pass_type == 'salt'){
            ...
            $hash = new PinnaclePasswordHash(10, true);
...
class PinnaclePasswordHash {
    ...
    function PinnaclePasswordHash($iteration_count_log2, $portable_hashes) {
